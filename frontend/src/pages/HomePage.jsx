  ...
  return (
    <>
      ...
      <div ref={containerRef} className="relative bg-black text-slate-200 font-sans selection:bg-white/10 selection:text-white overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-0 items-center">
              <div className="reveal-up max-w-4xl">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-white leading-[1.1] tracking-tight mb-8">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-400 to-white bg-[length:200%_auto] animate-gradient-move">Quasar</span>
                </h2>
        ...
        <section className="vision-section relative z-10 py-32 md:py-48 px-6 md:px-12 bg-black border-y border-white/[0.06] overflow-hidden">
          <div className="max-w-[1440px] mx-auto">
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                <div className="order-2 lg:order-1 rounded-[2.5rem] overflow-hidden aspect-[4/5] lg:aspect-square relative shadow-2xl bg-black reveal-up">
                  <video 
                    className="vision-image absolute inset-0 w-full h-full object-cover mix-blend-luminosity opacity-60 scale-[1.0]"
                    autoPlay muted loop playsInline
                    src="/videos/hallway.mp4" 
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent" />
                  <div className="absolute bottom-10 left-10 right-10">
                    <div className="p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl text-white">
                      ...
                      <p className="text-white/50 font-medium tracking-wide uppercase text-sm">Natilah Vision</p>
                    </div>
                  </div>
                </div>

                <div className="order-1 lg:order-2 reveal-up">
                  <p className="text-slate-400 font-medium tracking-widest uppercase mb-8 text-sm">Quantum Thinking</p>
                  <h2 className="text-4xl md:text-5xl font-light text-white leading-[1.1] tracking-tight mb-8">
