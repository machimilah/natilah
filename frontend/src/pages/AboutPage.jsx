  ...
  return (
    <>
      ...
      <section className="relative bg-[#0f0f10] py-24 md:py-32 border-t border-white/[0.06] overflow-hidden quantum-grid">
        <QuantumBackground particleCount={20} connectDistance={120} speed={0.15} opacity={0.10} colorScheme="green" />
      ...
      <section className="relative bg-[#0f0f10] py-24 md:py-32 border-t border-white/[0.06] overflow-hidden">
        <QuantumBackground particleCount={15} connectDistance={100} speed={0.2} opacity={0.10} colorScheme="purple" />
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <FadeInSection>
            <h2 className="text-3xl md:text-4xl lg:text-[48px] font-light text-white leading-[1.15] tracking-tight mb-12 max-w-4xl">
      ...
      {/* Values */}
      <section className="relative bg-[#0f0f10] py-24 md:py-32 border-t border-white/[0.06] overflow-hidden quantum-grid">
        <QuantumBackground particleCount={18} connectDistance={110} speed={0.18} opacity={0.10} colorScheme="cyan" />
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <FadeInSection>
      ...
      {/* Leadership */}
      <section className="relative bg-[#0f0f10] py-24 md:py-32 border-t border-white/[0.06] overflow-hidden">
        <QuantumBackground particleCount={15} connectDistance={100} speed={0.15} opacity={0.08} colorScheme="mixed" />
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <FadeInSection>
