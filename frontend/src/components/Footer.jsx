        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.linkedin.com/company/natilahpi/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors duration-300" aria-label="LinkedIn"><Linkedin size={18} /></a>
            </div>
          </div>
